...
class Config:
    API_ID = int(os.environ.get("API_ID", 0))  # Change 0 to your API_ID
    ...
    # Put your API_ID and OWNER_ID (without comma) and API_HASH,BOT_TOKEN n OWNER_NAME (with commas) above.
